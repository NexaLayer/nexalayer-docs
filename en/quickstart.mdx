...
`provisioning_mode=existing` attaches a resource already configured by support without placing another order or charging NexaLayer balance. Use `purchase` after recharging when you want to buy a new resource. Dynamic resources cost $4 / GB and static resources start at $10 / month.
