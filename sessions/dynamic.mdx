...
description: "Create and use dynamic (rotating) proxy sessions. Base URL: https://api.nexalayer.net/v1"
---
...
Next: [Rotate](/sessions/rotate) (change IP), [Terminate](/sessions/terminate).
