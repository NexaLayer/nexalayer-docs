...
description: "End-to-end journey and security test scope. Base URL: https://api.nexalayer.net/v1"
---
...
Tests use base URL `https://api.nexalayer.net/v1` and real field names from the API. Clean up sessions and test data after the run.

Next: [Testing overview](/testing/overview), [Errors](/errors).
