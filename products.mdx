---
title: Products
description: "List products, regions, and get recommendations. Base URL: https://api.nexalayer.net/v1"
---
...
```bash By type
curl -X GET "https://api.nexalayer.net/v1/products?type=dynamic" \
  -H "X-API-Key: <api_key>"
```

```bash By country
curl -X GET "https://api.nexalayer.net/v1/products?country=US" \
  -H "X-API-Key: <api_key>"
```
