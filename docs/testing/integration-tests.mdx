...
description: "Cross-system tests: Agent Layer vs Backend data. Base URL: https://agent-layer.up.railway.app/v1"
---
...
- Agent Layer base URL (e.g. `https://agent-layer.up.railway.app/v1`).
...
Next: [E2E](/docs/docs/testing/e2e), [Smoke tests](/docs/docs/testing/smoke-tests).
