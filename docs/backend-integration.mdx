...
- **Testing** — Integration tests (see [Integration tests](/docs/testing/integration-tests)) verify that Agent Layer operations produce the correct backend records (users, orders, transactions).
...
Next: [Architecture](/docs/architecture), [Testing overview](/docs/testing/overview).
