...
- **Testing** — Integration tests (see [Integration tests](/testing/integration-tests)) verify that Agent Layer operations produce the correct backend records (users, orders, transactions).
...
Next: [Architecture](/architecture), [Testing overview](/testing/overview).
