---
title: Errors
description: "Error format, codes, rate limits, and retry guidance. Base URL: https://agent-layer.up.railway.app/v1"
---
...
Next: [Best practices](/docs/docs/best-practices) (idempotency, telemetry, rotation).
