...
**recommendation:** `ok` \| `consider_rotate` \| `rotate_now` \| `pause`. Use it to decide when to call [Rotate](/docs/sessions/rotate).

Next: [Session health](/docs/telemetry/health), [Batch report](/docs/telemetry/batch).
