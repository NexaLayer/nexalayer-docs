...
**recommendation:** `ok` \| `consider_rotate` \| `rotate_now` \| `pause`. Use it to decide when to call [Rotate](/docs/docs/sessions/rotate).

Next: [Session health](/docs/docs/telemetry/health), [Batch report](/docs/docs/telemetry/batch).
